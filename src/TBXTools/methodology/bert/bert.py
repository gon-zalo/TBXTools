...
class BertMethodology(BaseMethodology):
    ...
    def __init__(self, model, labels=None):
        ...
        self.processor = BertProcessor(model_name=self.model_name, labels=self.labels)

        
    def extract(self, segments, verbose, by_segment=False, lemmatize=True):
        '''
        ...
        # print(clean_terms)
        dataframe['predicted_terms'] = clean_terms # here they are organized by segment, no?
        #check
